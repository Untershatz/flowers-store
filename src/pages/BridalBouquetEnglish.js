...
const BridalBouquetEnglish = () => {
    ...
    return (
        <Container fluid style={styles.container}>
            ...
            >
                <h1 style={styles.heading}>Bridal Bouquet</h1>
            </motion.div>
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                    ...
                    <Row className="justify-content-center">
                        {imagePaths.map((image, index) => (
                            <Col md={3} className="mb-4 d-flex justify-content-center" key={index}>
                                ...
                                >
                                    <img src={image} alt={`Bridal Bouquet ${index + 1}`} style={styles.cardImage} />
                                </motion.div>
                            </Col>
                        ))}
                    </Row>
...
export default BridalBouquetEnglish;
